...
export const ONGOING_ACTIVITIES: OngoingActivity[] = [
  // ----- Sport (all boost health) -----
  {
    ...
    category: 'sport',
    emoji: '🏋️',
    name: 'Workout at Fitness Center',
...
export const CRIMES: CrimeAction[] = [
  {
    ...
    emoji: '🖐️',
    name: 'Pickpocket',
    description: 'Lift a wallet — or a phone — from a distracted stranger. Small risk, small reward.',
    minAge: 10,
    catchChance: 0.25,
    reward: 300,
    success: { happiness: 2 },
    ...
    maxSentence: 1,
    loot: { kind: 'valuables', chance: 0.4 },
  },
  {
    id: 'shoplift',
    emoji: '🛍️',
    name: 'Shoplift',
    description: 'Walk out of the store with more than you paid for. Petty theft.',
    minAge: 10,
    catchChance: 0.3,
    reward: 400,
    success: { happiness: 2 },
    caught: { money: -600, happiness: -10, health: -1 },
    maxSentence: 1,
    loot: { kind: 'valuables', chance: 0.5 },
  },
  {
    id: 'robbery',
    emoji: '🔫',
    ...
    maxSentence: 5,
    loot: { kind: 'valuables', chance: 0.35 },
  },
  {
    id: 'scam',
    emoji: '💻',
  ...
  },
  {
    ...
    emoji: '🚗',
    name: 'Steal a car',
    description: 'Hotwire a nice ride and keep it — drive it or sell it. Grand theft auto.',
    minAge: 15,
    catchChance: 0.45,
    reward: 0,
    success: { happiness: 5 },
    ...
    maxSentence: 8,
    loot: { kind: 'car', chance: 1 },
  },
  {
    id: 'burglary',
    emoji: '🏚️',
    name: 'Burgle a house',
    description: 'Break into a home and clean out the valuables while nobody is watching.',
    minAge: 16,
    catchChance: 0.45,
    reward: 4000,
    success: { happiness: 5, health: -1 },
    caught: { money: -10000, happiness: -28, health: -6 },
    maxSentence: 10,
    loot: { kind: 'valuables', chance: 0.8 },
  },
  {
    id: 'bank-heist',
    emoji: '🏦',
    name: 'Rob a bank',
    description: 'The big score. Masks, a getaway car, and nerves of steel. Very high heat.',
    minAge: 18,
    catchChance: 0.55,
    reward: 60000,
    success: { happiness: 8, health: -2 },
    caught: { money: -20000, happiness: -35, health: -12 },
    maxSentence: 20,
  },
  {
    id: 'murder',
    emoji: '🔪',
    name: 'Murder',
    description: 'The darkest deed. Choose your victim — no going back, and a very good chance you get caught.',
    minAge: 16,
    catchChance: 0.6,
    reward: 0,
