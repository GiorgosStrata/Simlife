...
- **Interaction limits** — every relationship action (spend time, gift, pocket money, date) works once per person per year, resetting on each birthday, BitLife style. School actions were already yearly.
