...
- **Submenu pattern** — list rows open detail sheets (BitLife style): the school row opens your school (study + a classroom of 4 classmates and 2 teachers you can tap and interact with — befriend classmates at 60+ bond), any person row opens their interaction sheet, "Find a job" opens the job board. Classrooms rotate at each school stage; befriended classmates stay.
